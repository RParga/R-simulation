...
stopImplicitCluster()
area40 = as.numeric(largos[1, ])
area60 = as.numeric(largos[2, ])
area80 = as.numeric(largos[3, ])
area100 = as.numeric(largos[4, ])
png("p4_grieta80.png")
lbls = c("40^2", "60^2", "80^2", "100^2")
boxplot(area40, area60, area80, area100, col=c(20,7,19, 64), names = lbls, ylab="Longuitud de grieta", xlab="Tamaño de area", ylim = c(1, 200))
graphics.off()